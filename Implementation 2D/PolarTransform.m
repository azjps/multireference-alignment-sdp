% http://www.mathworks.com/matlabcentral/newsreader/view_thread/108599
...
% thetas = linspace(0, 2*pi , round(2*pi/dtheta) ); thetas = thetas(1:end-1)
% zoff are the coordinates of the sample points in the original image (x+iy)
% REA 4/15-6/1/05
if isscalar(rs)
  rs = 1:round(rs);
end
...
pim = interp2(img,imag(zoff),real(zoff),'nearest');