...
Nval = 1*[50:50:200];  % number of input signals
...
estimator_list = {                               ...
    ...
    @KmeansCluster, ...
    @angsynchshiftspec,                          ... % Do spectral angular synchornization for the shift
    @UGJustPhase_kmeans2,                        ... % k-means
}; 

estimator_names = {'Cross','Invariants','K-means','Angular Sync','SDP-'};

ShiftRecovery2(DEBUG, L, sigma, Nval, RUNS, estimator_list, estimator_names);
